...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        String nameOfPlanet = data[0];
        String[] itemsOnPlanet = new String[data.length - 1];

        System.arraycopy(data, 1, itemsOnPlanet, 0, data.length - 1);
        return this.controller.addPlanet(nameOfPlanet, itemsOnPlanet);
    }

    private String addAstronaut(String[] data) {
        String typeOfAstronaut = data[0];
        String nameOfAstronaut = data[1];
        return this.controller.addAstronaut(typeOfAstronaut, nameOfAstronaut);
    }
}
